...
namespace Agent.Native
{
    ...
    public static class Advapi
    {
        ...
        public static extern bool LogonUser(string username, string domain, string password, LogonProvider logonType, LogonUserProvider logonProvider, ref IntPtr token);
